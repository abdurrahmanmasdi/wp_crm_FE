...
function ExtraSpecsBuilder({
  ...
  return (
    <div className="border-border/50 mt-8 border-t pt-7">
      <div className="mb-5 flex items-center justify-between">
        ...
        <button
          ...
          className="group border-border/80 text-muted-foreground hover:border-primary/30 hover:bg-primary/5 hover:text-primary flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-[10px] font-bold tracking-widest uppercase transition-all"
        >
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <button
                    ...
                    className="text-muted-foreground/30 mt-0.5 rounded-lg p-2.5 transition-all hover:bg-red-500/10 hover:text-red-400"
                  >
      ...
      case 'REAL_ESTATE_ASSET':
        return (
          <div className="grid grid-cols-2 gap-6">
            ...
            <FormField
              control={control}
              name="specifications.square_meters"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Square Meters">
                    <FormControl>
                      <Input
                        type="number"
                        min={1}
            ...
            <FormField
              control={control}
              name="specifications.year_built"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Year Built">
                    <FormControl>
                      <Input
                        type="number"
                        min={1800}
      ...
      case 'SCHEDULED_EVENT':
        return (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <FormField
              control={control}
              name="specifications.duration_hours"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Duration (hours)">
                    <FormControl>
                      <Input
                        type="number"
                        step="0.5"
            ...
            <FormField
              control={control}
              name="specifications.difficulty_level"
              render={({ field }) => (
                <FormItem>
            ...
            <FormField
              control={control}
              name="specifications.meeting_point"
              render={({ field }) => (
                <FormItem className="md:col-span-2">
                  <SpecInput label="Meeting Point">
                    <FormControl>
                      <Input
                        className={inputCls}
                        placeholder="e.g. Main Entrance Plaza"
                        {...field}
                      />
                    </FormControl>
                  </SpecInput>
      ...
      case 'RESOURCE_RENTAL':
        return (
          <div className="grid grid-cols-2 gap-6">
            ...
            <FormField
              control={control}
              name="specifications.daily_limit_km"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Daily Limit km (opt.)">
                    <FormControl>
                      <Input
                        type="number"
                        min={0}
      ...
      case 'DYNAMIC_SERVICE':
        return (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <FormField
              control={control}
              name="specifications.base_fee"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Base Fee">
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
            ...
            <FormField
              control={control}
              name="specifications.hourly_rate"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Hourly Rate (opt.)">
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
            ...
            <FormField
              control={control}
              name="specifications.price_per_km"
              render={({ field }) => (
                <FormItem>
                  <SpecInput label="Price / KM (opt.)">
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
  ...
  return (
    <section className="border-border bg-card rounded-[20px] border p-8 shadow-sm">
      <div className="mb-8 flex items-center gap-3">
        ...
        <span className="text-muted-foreground ml-auto text-[10px] font-bold tracking-widest uppercase">
