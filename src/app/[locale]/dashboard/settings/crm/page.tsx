...
import { PipelineStagesSettings } from '@/components/settings/crm/PipelineStagesSettings';
...
export default function CRMSettingsPage() {
  ...
  return (
    <Tabs defaultValue="pipelineStages" className="space-y-6">
      ...
      <TabsContent value="pipelineStages" className="mt-0">
