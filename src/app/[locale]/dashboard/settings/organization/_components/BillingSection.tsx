    ...
    <SectionCard title="Billing" icon={CreditCard}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-2xl font-bold tracking-tight text-white">Enterprise Plus</p>
        ...
        >
          <span className="text-xs font-bold tracking-widest uppercase">Manage Subscription</span>
