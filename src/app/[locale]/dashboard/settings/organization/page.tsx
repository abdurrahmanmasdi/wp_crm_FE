...
function OrganizationSettingsForm() {
  const { form, isLoading, isError, isSaving, onSubmit, onRetry, onDiscard } = useOrganizationSettings();
  ...
  if (isError) {
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center gap-4 text-center">
        ...
        <div>
          <p className="text-lg font-semibold text-white">Failed to load organization</p>
          <p className="text-on-surface-variant mt-1 text-sm">
            We couldn&apos;t fetch your organization data. Please check your connection and try again.
          </p>
        </div>
        <Button
          type="button"
